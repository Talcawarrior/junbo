...
| **SPREAD_MAX_ENTRY 0.50 — 0.50+ fiyata O SEHRE HIC GIRILMEZ (2026-08-11)** | Kullanici tespiti: merkez esige 0.50 ile girilirse kazanc sadece 2x (2$ stake -> 2$), ayni sehirde 6 longshot kaybi 12$ -> net -10$/sehir. Backtest zaten `max_entry<0.30 -> +$36,814` demisti. Karar: `spread_max_entry=0.50` — 0.50 ve ustu fiyatli esikler acilmaz; kenarlar (longshot) ve merkez 0.50 altindaysa acilir. `.env` + `settings.py` senkron. |
