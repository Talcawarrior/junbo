"""Quick CI — Her kod degisikligi ve bot basladiginda calistir.
...
Kullanim:
    python quick_check.py          # tum testler (~90s)
    python quick_check.py --fast   # sadece lint + import (~15s)

Cikis kodu: 0 = tumu gecti, 1 = hata var
"""
...
def run(name: str, cmd: list[str], fast_only: bool = False) -> bool:
    """Tek test calistir, sonucu yazdir."""
